...
public class NetworkHandlerTest {
    ...
    @Test
    public void testCanUpdateNetworkOk() throws IOException {
        Activator.apiConnector = mockedApiConnector;
        NeutronNetwork neutronNetwork = defaultNeutronObject();
        NeutronNetwork deltaNeutronNetwork = defaultNeutronObjectUpdate();
        when(mockedApiConnector.findById(VirtualNetwork.class, neutronNetwork.getNetworkUUID())).thenReturn(mockedVirtualNetwork);
    ...
    /* Test method to check neutron network delete with HTTP OK */
    @Test
     ...
     */
    @Test
    public void testaddNetworkVirtualNetworkFalse() throws Exception {
        Activator.apiConnector = mockedApiConnector;
        NeutronNetwork neutronNetwork = defaultNeutronObject();
        ...
        assertEquals(false, networkHandler.addNetwork(neutronNetwork));
    }

    /*
     * Test method to check neutron network creation of floating IPs failed
     */
    @Test
    public void testaddNetworkFloatingIPFalse() throws Exception {
    }

    /* Test method to check neutron network updation failed */
    @Test
    public void testupdateNetworkFailed() throws Exception {
        Activator.apiConnector = mockedApiConnector;
        NeutronNetwork neutronNetwork = defaultNeutronObject();
        ...
        assertEquals(false, networkHandler.updateNetwork(neutronNetwork.getNetworkUUID(), deltaNetwork));
    }

    /* Test method to check neutron network updated floatingIP creation failed */
    @Test
    public void testupdateNetworkCreateFloatingIpPoolFailed() throws Exception {
        Activator.apiConnector = mockedApiConnector;
        NeutronNetwork neutronNetwork = defaultNeutronObject();
        NeutronNetwork deltaNetwork = defaultNeutronObjectUpdate();
        when(mockedApiConnector.findById(VirtualNetwork.class, neutronNetwork.getNetworkUUID())).thenReturn(mockedVirtualNetwork);
    ...
    // */
    // @Test
    // @PrepareForTest({ VirtualNetwork.class , FloatingIpPool.class })
    // public void testupdateNetworkOKif() throws Exception {
    // Activator.apiConnector = mockedApiConnector;
    // NeutronNetwork neutronNetwork = defaultNeutronObject();
    // NeutronNetwork deltaNetwork = defaultNeutronObjectUpdate();
    // when(mockedApiConnector.findById(VirtualNetwork.class,
    // neutronNetwork.getNetworkUUID())).thenReturn(mockedVirtualNetwork);
    // // mockedVirtualNetwork.setName(deltaNetwork.getNetworkName());
    // // mockedVirtualNetwork.setDisplayName(deltaNetwork.getNetworkName());
    // when(mockedApiConnector.update(mockedVirtualNetwork)).thenReturn(true);
    // neutronNetwork.setRouterExternal(false);
    ...
    // PowerMock.createNiceMock(FloatingIpPool.class);
    // expectNew(FloatingIpPool.class).andReturn(floatingIpPool);
    // // String fipId = UUID.randomUUID().toString();
    ...
    //
    // assertEquals(true,
    // networkHandler.updateNetwork(neutronNetwork.getNetworkUUID(),
    // deltaNetwork));
    // }
